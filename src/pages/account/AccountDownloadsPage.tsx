...
export default function AccountDownloadsPage() {
  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="show" className="relative min-h-[calc(100vh-52px)] bg-[#0a0a12] px-5 py-6 text-[#e8eaf0] lg:px-8">
      ...
      {inProductCenter ? (
        <motion.section variants={itemVariants} className="relative mx-auto mt-6 max-w-[1500px] space-y-5">
          <div className="flex flex-wrap gap-2 rounded-[28px] border border-white/10 bg-[#080b11]/92 p-4 shadow-[0_16px_48px_rgba(0,0,0,0.32)]">
            {[
              ['任务', `${downloads.length}`],
      ...
      <motion.section variants={itemVariants} className={`relative mx-auto mt-6 max-w-[1500px] grid-cols-1 gap-4 sm:grid-cols-3 ${inProductCenter ? 'hidden' : 'grid'}`}>
        {stats.map((item) => (
          <motion.div variants={itemVariants} key={item.label} className="rounded-[28px] border border-white/10 bg-[#080b11]/92 p-5 shadow-[0_16px_48px_rgba(0,0,0,0.32)] ring-1 ring-cyan-300/5 transition hover:border-cyan-200/20 hover:bg-[#101722]">
      ...
      {/* Filters */}
      <motion.section variants={itemVariants} className={`relative mx-auto mt-6 max-w-[1500px] rounded-[28px] border border-white/10 bg-[#080b11]/92 p-5 shadow-[0_16px_48px_rgba(0,0,0,0.32)] backdrop-blur-md ${inProductCenter ? 'hidden' : ''}`}>
      ...
      <div className={`mx-auto mt-6 max-w-[1500px] grid-cols-1 gap-6 lg:grid-cols-[1fr_350px] ${inProductCenter ? 'hidden' : 'grid'}`}>
        {/* Main Records */}
        <motion.section variants={itemVariants} className="rounded-[28px] border border-white/10 bg-[#080b11]/92 backdrop-blur-md flex flex-col h-full overflow-hidden">
