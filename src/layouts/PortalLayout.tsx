...
export default function PortalLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[var(--ecom-bg)]">
      ...
      <footer className="border-t border-white/[0.06] bg-[rgba(255,255,255,0.055)]">
        <div className="max-w-7xl mx-auto px-6 py-16 safe-area-inset">
                ...
                <ul className="space-y-2.5">
                  {col.links.map(link => (
                    <li key={`${col.title}-${link.to}-${link.label}`}>
                      <Link to={link.to} className="text-sm text-[var(--ecom-text-secondary)] transition-colors hover:text-[var(--ecom-text-primary)]">
                        {link.label}
                      </Link>
                    </li>
                  ))}
          ...
          <div className="mt-14 pt-6 border-t border-white/[0.06] flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-[var(--ecom-text-muted)]">{t('common.copyright', { year: new Date().getFullYear() })}</p>
            <div className="flex items-center gap-4">
              <a href="https://twitter.com" target="_blank" rel="noreferrer" aria-label="X / Twitter" className="text-[var(--ecom-text-muted)] transition-colors hover:text-[var(--ecom-text-primary)]">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://github.com" target="_blank" rel="noreferrer" aria-label="GitHub" className="text-[var(--ecom-text-muted)] transition-colors hover:text-[var(--ecom-text-primary)]">
              ...
              <a href="https://discord.com" target="_blank" rel="noreferrer" aria-label="Discord" className="text-[var(--ecom-text-muted)] transition-colors hover:text-[var(--ecom-text-primary)]">
